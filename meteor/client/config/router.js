...
Router.route('/paperaccess', function () {
    this.render('paperaccess');
});
//
Router.route('/createpaper',function(){
  this.render('createpaper');
});
// Dashboards routes
Router.route('/paperaccess/paperedit',function(){
