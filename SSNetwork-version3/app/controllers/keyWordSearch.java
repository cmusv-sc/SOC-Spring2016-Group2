...
//            result.put("order",scoreDoc.doc);
//            result.put("score",scoreDoc.score);
              System.out.println("dddddd"+document.get("All"));
//            result.put("all",document.get("All"));
...
//          result.put("order",scoreDoc.doc);
//          result.put("score",scoreDoc.score);
            System.out.println("keyword:"+document.get("All"));
            if(!keywords.contains(document.get("All"))) {
                ...
                System.out.println(author_ids.size());
